...
- 코드 폴더 지도 [source: reference/unity_project_baseline.md 기준 구조]
...
- 구조 자체의 변경(새 최상위 폴더 추가 등)은 사람 승인이 필요하다. [source: reference/unity_project_baseline.md]
...
4. 계획 보고서에 파일 경로를 정확히 적는다. Developer AI는 계획에 없는 파일을 만들지 않는다. [source: reference/unity_project_baseline.md 작업 순서]
...
- 계획 일치 검사: devreport의 변경 파일 목록이 계획서의 파일 목록과 일치하는지 확인. [source: reference/unity_project_baseline.md 보고서 양식]
